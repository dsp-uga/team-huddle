"""
This code is heavily based on Deepak Pathak's implementation of Coarse2Fine Optical Flow in Python.
The original code was written in C++.
We have used this code in our project for doing optical flow. 
...
im1 = np.array(Image.open('examples/frame0001.jpg'))
im2 = np.array(Image.open('examples/frame0095.jpg'))
